...
public:
    ...
    unsigned int upFacesMetadaBufferID = 0;
    unsigned int downFacesMetadaBufferID = 0;
    unsigned int frontFacesMetadaBufferID = 0;
    unsigned int backFacesMetadaBufferID = 0;
    unsigned int rightFacesMetadaBufferID = 0;
    unsigned int leftFacesMetadaBufferID = 0;

    unsigned int chunkPositionsVBOID = 0;
    unsigned int commandsBufferVBOID = 0;
    unsigned int commandsLengthBOID = 0;
};
...
void DrawMeshMultiInstancedDrawIndirectGPU(GenerativeMesh& genMesh, Material material, const int* instancePositions, int instances, std::vector<DrawArraysIndirectCommand>& commands, unsigned int numCommands, bool bindTextures = true)
{
    // Bind shader program
    rlEnableShader(material.shader.id);
...
void DrawMeshMultiInstancedDrawIndirectGPU2(GenerativeMesh& genMesh, Material material, const int* instancePositions, int instances, unsigned int maxNumCommands, bool bindTextures = true)
{
    // Bind shader program
    rlEnableShader(material.shader.id);
